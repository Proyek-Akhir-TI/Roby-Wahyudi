						...
						<div class="col-lg-6">
							<div class="p-5">
								<div class="text-center">
									<h1 class="h4 text-gray-900 ">Atur Ulang Password</h1>
									<h4 class="h4 text-gray-900 ">Untuk Akun :</h4>
									<h5 class="h4 text-gray-900 mb-4"><?= $this->session->userdata('reset_email'); ?></h5>

								</div>
								<?= $this->session->flashdata('message'); ?>
								<form class="user" method="post" action="<?= base_url('authentication/changepassword'); ?>">
